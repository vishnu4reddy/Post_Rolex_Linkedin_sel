...
def test_linkedin():
    ...
    driver.find_element(
        By.XPATH, "//div[@aria-label='Text editor for creating content']//p").send_keys("Love the Watch")
    driver.find_element(By.XPATH, "//span[normalize-space()='Post']").click()
    driver.find_element(
        By.CSS_SELECTOR, ".artdeco-button.artdeco-button--tertiary.artdeco-button--3.mb3").click()
    driver.find_element(By.ID, "ember16").click()
    driver.find_element(
        By.XPATH, ".artdeco-button.artdeco-button--tertiary.artdeco-button--3.mb3").clcik()
